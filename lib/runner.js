...
var STATE_PASSED = Test.constants.STATE_PASSED;
...
Runner.prototype.run = function(fn) {
  ...
  if (this._delay) {
    ...
    this.emit(constants.EVENT_RUN_DELAY, rootSuite);
...
Runner.constants = Object.freeze(constants);
